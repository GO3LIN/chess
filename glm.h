...
typedef struct _GLMmaterial
{
  ...
  GLint map_diffuse;     /* diffuse texture ID //?? */
#if 0
...
typedef struct _GLMtriangle {
  ...
  GLint nindices[3];           /* array of triangle normal indices ??*/
  GLint tindices[3];           /* array of triangle texcoord indices //?? */
  GLint findex;                /* index of triangle facet normal //?? */ 
